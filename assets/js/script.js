...
let testemonials = [
    {quote:'"Transforme qualquer momento '+
     'com a beleza e frescor das nossas flores!"', origin:'cbs.svg' }, 
    {quote:'"No Flor de Anis, cada arranjo '+ 
        'é uma obra de arte feita especialmente para você. ', origin:'forbes.svg' }, 
    {quote:'"Flores que encantam, aromas '+ 
        'que acolhem. Descubra a magia do Flor de Anis."', origin:'fox.svg' }, 
    {quote:'"Beleza e frescor em cada flor. Flor de Anis, a delicadeza que você merece."',
